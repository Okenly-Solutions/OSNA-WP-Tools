...
class Ultimate_Sliders_Post_Type {
    ...
    public function render_slider_settings_meta_box($post) {
        ...
        <div class="osna-admin-panel">
            ...
            <div class="osna-field-group">
                ...
                <input type="number" id="ultimate_slider_autoplay_speed" name="ultimate_slider_autoplay_speed" value="<?php echo esc_attr($autoplay_speed); ?>" min="1000" step="500">
            </div>
            ...
            <div class="osna-field-group">
                ...
                <select id="ultimate_slider_transition_effect" name="ultimate_slider_transition_effect">
                    <option value="fade" <?php selected($transition_effect, 'fade'); ?>><?php _e('Fade', 'osna-wp-tools'); ?></option>
                    <option value="slide" <?php selected($transition_effect, 'slide'); ?>><?php _e('Slide', 'osna-wp-tools'); ?></option>
                </select>
            </div>
            ...
            <div class="osna-field-group">
                ...
                <input type="text" id="ultimate_slider_continue_button_text" name="ultimate_slider_continue_button_text" value="<?php echo esc_attr($continue_button_text); ?>">
            </div>
        </div>
        <?php
    }
    ...
    public function render_slider_slides_meta_box($post) {
        ...
        <div class="osna-admin-panel">
            ...
            <button type="button" class="button button-primary" id="add-slide"><?php _e('Add Slide', 'osna-wp-tools'); ?></button>
        </div>
    ...
    private function render_slide_fields($index, $slide = array()) {
        ...
        <div class="slide-container" data-index="<?php echo esc_attr($index); ?>">
            <div class="slide-header">
                <h3><?php printf(__('Slide %s', 'osna-wp-tools'), $index + 1); ?></h3>
            ...
            <div class="slide-content">
                <div class="osna-field-group">
                    ...
                    <select id="slides[<?php echo $index; ?>][media_type]" name="slides[<?php echo $index; ?>][media_type]" class="media-type-select">
                        <option value="image" <?php selected($media_type, 'image'); ?>><?php _e('Image', 'osna-wp-tools'); ?></option>
                        <option value="video" <?php selected($media_type, 'video'); ?>><?php _e('Video', 'osna-wp-tools'); ?></option>
                    </select>
                </div>
                ...
                <div class="osna-field-group media-field image-field" <?php echo $media_type !== 'image' ? 'style="display:none;"' : ''; ?>>
                    ...
                    <div class="image-preview-container">
                        ...
                        <input type="hidden" id="slides[<?php echo $index; ?>][image_id]" name="slides[<?php echo $index; ?>][image_id]" value="<?php echo esc_attr($image_id); ?>">
                ...
                <div class="osna-field-group media-field video-field" <?php echo $media_type !== 'video' ? 'style="display:none;"' : ''; ?>>
                    ...
                    <input type="url" id="slides[<?php echo $index; ?>][video_url]" name="slides[<?php echo $index; ?>][video_url]" value="<?php echo esc_attr($video_url); ?>" placeholder="https://example.com/video.mp4">
                    <p class="description"><?php _e('Enter the URL of the video file (MP4, WebM, etc.) or YouTube/Vimeo embed URL.', 'osna-wp-tools'); ?></p>
                </div>
                
                <div class="osna-field-group">
                    <label for="slides[<?php echo $index; ?>][title]"><?php _e('Title', 'osna-wp-tools'); ?></label>
                    <input type="text" id="slides[<?php echo $index; ?>][title]" name="slides[<?php echo $index; ?>][title]" value="<?php echo esc_attr($title); ?>">
                </div>
                
                <div class="osna-field-group">
                    <label for="slides[<?php echo $index; ?>][description]"><?php _e('Description', 'osna-wp-tools'); ?></label>
                    <textarea id="slides[<?php echo $index; ?>][description]" name="slides[<?php echo $index; ?>][description]" rows="3"><?php echo esc_textarea($description); ?></textarea>
                </div>
                
                <div class="osna-field-group">
                    <label for="slides[<?php echo $index; ?>][cta_text]"><?php _e('Call to Action Text', 'osna-wp-tools'); ?></label>
                    <input type="text" id="slides[<?php echo $index; ?>][cta_text]" name="slides[<?php echo $index; ?>][cta_text]" value="<?php echo esc_attr($cta_text); ?>">
                </div>
                
                <div class="osna-field-group">
                    <label for="slides[<?php echo $index; ?>][cta_url]"><?php _e('Call to Action URL', 'osna-wp-tools'); ?></label>
                    <input type="url" id="slides[<?php echo $index; ?>][cta_url]" name="slides[<?php echo $index; ?>][cta_url]" value="<?php echo esc_attr($cta_url); ?>">
                </div>
                
                <div class="osna-field-group">
                    <label for="slides[<?php echo $index; ?>][background_color]"><?php _e('Background Color', 'osna-wp-tools'); ?></label>
                    <input type="color" id="slides[<?php echo $index; ?>][background_color]" name="slides[<?php echo $index; ?>][background_color]" value="<?php echo esc_attr($background_color); ?>">
                </div>
                
                <div class="osna-field-group">
                    <label for="slides[<?php echo $index; ?>][text_color]"><?php _e('Text Color', 'osna-wp-tools'); ?></label>
                    <input type="color" id="slides[<?php echo $index; ?>][text_color]" name="slides[<?php echo $index; ?>][text_color]" value="<?php echo esc_attr($text_color); ?>">
                </div>
            </div>
        </div>
        <?php

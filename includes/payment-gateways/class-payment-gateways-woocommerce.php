...
class Payment_Gateways_WooCommerce
{
    ...
    public function init()
    {
        ...
        // Include the WooCommerce payment gateway class
        add_action('plugins_loaded', array($this, 'include_payment_gateway_class'));
    }
     ...
     * @since    1.0.0
     */
    public function include_payment_gateway_class()
    {

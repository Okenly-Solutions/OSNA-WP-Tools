    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden max-w-7xl mx-auto my-8">
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <!-- Coming Soon Card -->
                <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md transition-all duration-300 hover:shadow-lg opacity-75">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                        ...
                        <p class="text-gray-600 mb-6">We're working on more tools to enhance your WordPress site. Stay tuned for updates!</p>
                        
                        <div class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-gray-600 bg-gray-200 cursor-not-allowed">
                            Coming Soon
                        </div>
                    </div>
                </div>
